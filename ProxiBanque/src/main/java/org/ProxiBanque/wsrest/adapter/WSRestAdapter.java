...
public abstract class WSRestAdapter {
	...
	public static CurrentAccount marshallCurrentAccount(org.ProxiBanque.model.CurrentAccount current) {
		...
		CurrentAccount marshallCurrent = new CurrentAccount(current.getDecouvert(),
				current.getSold());
	...
	public static org.ProxiBanque.model.CurrentAccount unmarshallCurrentAccount(CurrentAccount current) {
		...
		org.ProxiBanque.model.CurrentAccount unmarshallCurrent = new org.ProxiBanque.model.CurrentAccount(current.getDecouvert(),
				current.getSold());
	...
	public static SavingAccount marshallSavingAccount(org.ProxiBanque.model.SavingAccount saving) {
		...
		SavingAccount marshallSaving = new SavingAccount(saving.getSold(),
	...
	public static org.ProxiBanque.model.SavingAccount unmarshallSavingAccount(SavingAccount saving) {
		...
		org.ProxiBanque.model.SavingAccount unmarshallSaving = new org.ProxiBanque.model.SavingAccount(saving.getSold(),
				saving.getTauxDeRemuneration(), saving.getDecouvert());
	...
	public static Address marshallAddress(org.ProxiBanque.model.Address address) {
		...
		Address marshallAddress = new Address();
	...
	public static org.ProxiBanque.model.Address unmarshallAddress(Address address) {
		...
		org.ProxiBanque.model.Address unmarshallAddress = new org.ProxiBanque.model.Address();
	...
	public static Client marshallClient(org.ProxiBanque.model.Client client) {
		...
		Client marhallClient = new Client(client.getFirstName(), client.getLastName(), marshallAddress(client.getAddress()), client.getType(),
				client.isRitch());
	...
	public static org.ProxiBanque.model.Client unmarshallClient(Client client) {
		...
		org.ProxiBanque.model.Client unmarhallClient = new org.ProxiBanque.model.Client(client.getFirstName(), client.getLastName(), unmarshallAddress(client.getAddress()));
	...
	public static Director marshallDirector(org.ProxiBanque.model.Director director) {
		...
		Director marhallDirector = new Director(director.getFirstName(), director.getLastName(), marshallAddress(director.getAddress()));
	...
	public static org.ProxiBanque.model.Director unmarshallDirector(Director director) {
		...
		org.ProxiBanque.model.Director unmarhallDirector = new org.ProxiBanque.model.Director(director.getFirstName(), director.getLastName(), unmarshallAddress(director.getAddress()));
	...
	public static Advisor marshallAdvisor(org.ProxiBanque.model.Advisor advisor) {
		...
		Advisor marshallAdvisor = new Advisor(advisor.getFirstName(), advisor.getLastName(), marshallAddress(advisor.getAddress()));
	...
	public static org.ProxiBanque.model.Advisor unmarshallAdvisor(Advisor advisor) {
		...
		org.ProxiBanque.model.Advisor unmarshallAdvisor = new org.ProxiBanque.model.Advisor(advisor.getFirstName(), advisor.getLastName(), unmarshallAddress(advisor.getAddress()));
...
public static Agence marshallAgence(org.ProxiBanque.model.Agence agence) {
		...
		Agence marshallAgence = new Agence(agence.getDateCreation());
	...
	public static org.ProxiBanque.model.Agence unmarshallAgence(Agence agence) {
		...
		org.ProxiBanque.model.Agence unmarshallAgence = new org.ProxiBanque.model.Agence(agence.getDateCreation());
